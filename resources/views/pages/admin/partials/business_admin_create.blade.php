<div class="col-md-12">
    {!! Form::open(array('route' => 'admin.users.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'business_admin_form')) !!}
    ...
    {!! Form::button(trans('forms.create_user_button_text'), array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit', 'id' => 'business_admin_submit')) !!}
    {!! Form::close() !!}
</div>
