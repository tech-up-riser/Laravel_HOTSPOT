<div class="col-md-12">
    {!! Form::open(array('route' => 'admin.business.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'business_form')) !!}
    ...
    <div class="form-group has-feedback row {{ $errors->has('business_name') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('business_name', NULL, array('id' => 'business_name', 'class' => 'form-control', 'placeholder' => 'coava_coffee_shop')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('business_fullname') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('business_fullname', NULL, array('id' => 'business_fullname', 'class' => 'form-control', 'placeholder' => 'Coava Coffee Shop')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('owner_name') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('owner_name', NULL, array('id' => 'owner_name', 'class' => 'form-control', 'placeholder' => 'John William')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('email') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('business_email', NULL, array('class' => 'form-control', 'placeholder' => 'Business Email')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('address1') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('address1', NULL, array('id' => 'address1', 'class' => 'form-control', 'placeholder' => '140 Yonge St')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('address2') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('address2', NULL, array('id' => 'address2', 'class' => 'form-control', 'placeholder' => 'Ap 204')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('city') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('city', NULL, array('id' => 'city', 'class' => 'form-control', 'placeholder' => 'Toronto')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('country') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('business_country', NULL, array('id' => 'business_country', 'class' => 'form-control', 'placeholder' => 'Canada')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('postcode') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('postcode', NULL, array('id' => 'postcode', 'class' => 'form-control', 'placeholder' => 'M4C 5K7')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('facebook_link') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('facebook_link', NULL, array('id' => 'facebook_link', 'class' => 'form-control', 'placeholder' => 'Please Enter your company Facebook link')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('twitter_link') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('twitter_link', NULL, array('id' => 'twitter_link', 'class' => 'form-control', 'placeholder' => 'Please Enter your company Twitter link')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('instagram_link') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('instagram_link', NULL, array('id' => 'instagram_link', 'class' => 'form-control', 'placeholder' => 'Please Enter your company Instagram link')) !!}
            </div>
    ...
    <div class="form-group has-feedback row {{ $errors->has('linkedin_link') ? ' has-error ' : '' }}">
        ...
        <div class="col-md-9">
            <div class="input-group">
                {!! Form::text('linkedin_link', NULL, array('id' => 'linkedin_link', 'class' => 'form-control', 'placeholder' => 'Please Enter your company Linkedin link')) !!}
            </div>
    ...
    {!! Form::button('Create New Business', array('id' => "business_submit", 'class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
    {!! Form::close() !!}
</div>