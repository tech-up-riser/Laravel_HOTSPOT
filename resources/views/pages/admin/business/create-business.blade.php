        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <ul class="nav nav-tabs m-b-2" id="create_business">
                    <li class="active">
                        <a href="#new_business" id="li_create_business" data-toggle="tab" class="active show">Create New Business</a>
                    </li>
                    <li>
                        <a href="#business_admin" id="li_business_admin" data-toggle="tab">Create Business Admin</a>
                    </li>
                    <li>
                    ...
                    <div class="card-body">
                        <div class="tab-content clearfix">
                            <div class="tab-pane active" id="new_business">
                                @include('pages.admin.partials.business_create')
                            </div>
                            <div class="tab-pane" id="business_admin">
                                @include('pages.admin.partials.business_admin_create')
                            </div>
