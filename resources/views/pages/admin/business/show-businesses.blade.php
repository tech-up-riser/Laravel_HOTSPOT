                                ...
                                @foreach($businesses as $business)
                                    <tr>
                                        ...
                                        <td class="actions" width="180px">
                                            ...
                                            {!! Form::button(trans('usersmanagement.buttons.delete'), array('class' => 'btn btn-danger btn-sm','type' => 'button' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Business', 'data-message' => 'Are you sure you want to delete this business ?')) !!}
                                            {!! Form::close() !!}
