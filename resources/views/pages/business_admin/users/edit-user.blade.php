        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            {!! Form::open(array('route' => ['business.admin.users.update', $bzname, $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('gender') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <select class="form-control" name="gender" id="gender" style="text-transform: capitalize;">
                            ...
                            {!! Form::button("Update User", array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
