...
return [
    ...
    'buttons' => [
        'create-new'    => 'New User',
        'delete'        => '<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i></span>',
        'show'          => '<i class="fa fa-eye fa-fw" aria-hidden="true"></i></span>',
        'edit'          => '<i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>',
